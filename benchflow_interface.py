#!/usr/bin/env python3
# BenchFlow Interface for AgentHarm
# This file is a template for integrating AgentHarm with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading AgentHarm benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "version": "1.0.0",
            "category": "safeguards",
            "github": "https://github.com/aisi-eth/agentharm",
            "paper": "",
            "website": ""
        }
